"""Optimizer construction and the released warmup/cosine LR schedule."""
...
def build_optimizer(model, args):
    """Build AdamW over parameters that are trainable at initialization."""
...
def adjust_learning_rate(param_group, base_lr, epoch_progress, args):
    """Apply linear warmup followed by cosine decay at fractional epochs."""
    min_lr = 5e-6
