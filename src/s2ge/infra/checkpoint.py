"""Atomic checkpoint naming, persistence, and restoration."""
...
class CheckpointManager:
    """Own checkpoint and prediction paths for one configured run."""
    ...
    def save(self, model, optimizer, epoch: int, is_best=False, train_state=None, suffix=None):
        """Atomically save model state and optional optimizer/resume metadata."""
    ...
    def load_best(self, model):
        """Load the best checkpoint into ``model`` and return that object."""
