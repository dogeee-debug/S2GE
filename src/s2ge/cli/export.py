"""Export helper for optional offline dataset, model, and wheel bundles."""
...
def main(argv=None):
    """Dispatch the selected packaging scripts.

    The minimal camera-ready source archive does not include ``local_prep``;
    this command is retained for maintainers of the full internal checkout.
    """
